...
var profile_active_exists: bool:
	get: return profile_active != null
...
func add_profile_at_path(path: String, make_active: bool = true) -> Profile:
...
func remove_profile(profile: Profile) -> void:
